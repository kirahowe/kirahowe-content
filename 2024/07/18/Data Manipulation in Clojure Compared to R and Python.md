---
slug: tablecloth-dplyr-pandas-polars
tags:
  - clojure
  - data-science
  - scicloj
...
previously:
  ...
  - /2024-07-18-tablecloth-dplyr-pandas-polars.html
---
...
(def ds 
  (tc/dataset "https://kirahowe.com/attachments/penguins.csv"))
```
...
ds <- read_csv("https://kirahowe.com/attachments/penguins.csv",
               na = "NA")
```
### Pandas
```python
...
ds = pd.read_csv("https://kirahowe.com/attachments/penguins.csv")
```
...
ds = pl.read_csv("https://kirahowe.com/attachments/penguins.csv",
                 null_values="NA")
```
